...
<? } else {
	...
	?>
    <div align="left" id="linktargetdiv" <? if ($_GET['type'] == 'forum topic'){?>style="display:none;"<? }?>><div style="height:5px;"></div>
    ...
    <div style="height:5px;"></div>
<div id="thumbselect" align="left" class="messageinfo_white"<? if (($ExciteType == 'project') ||($ExciteType == 'forum topic')){?> style="display:none;"<? }?>>
<div style="height:10px;"></div>
   5. UPLOAD THUMBNAIL 
