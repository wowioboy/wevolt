...
function build_string() {
	...
	$StringEntries = '';
		...
		$query = "SELECT se.LinkID,se.IsMarked,se.ID as EntryID, se.UserID, se.LastVisited, sl.* from string_entries as se
				  ...
				  where se.UserID='$UserID' and sl.Title != '' order by se.LastVisited limit 50";
		$InitDB->query($query);
		...
		while ($line = $InitDB->FetchNextObject()) {
			...
			$StringEntries .='<li><div class="'.$Status.'" id=\'string_'.$line->EntryID.'\' onclick="mini_menu(\''.$line->Title.'\',\''.$line->Url.'\',\''.$line->EntryID.'\',\'string\',\''.$Status.'\',this, event);return false;" ><div style=\'height:2px;\'></div><span id=\'string_'.$Class.'title\'>'.$StringTitle.'&nbsp;&nbsp;&nbsp;</span><br/><span id=\'string_'.$Class.'subtitle\'>'.$SubTitle.'&nbsp;&nbsp;&nbsp;&nbsp;</span><br/><span id=\'string_'.$Class.'subtitle\'>'.$SubSubTitle.'&nbsp;&nbsp;&nbsp;&nbsp;</span></div></li>';
	/*
