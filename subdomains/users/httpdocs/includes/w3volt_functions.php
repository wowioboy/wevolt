...
global $ModuleTitleArray,$ModuleIndex, $UserID;
	...
	//$PopMenuString.="<div id='".$MenuModule."_menu' style='display:none; position:absolute;' class='action_pop'><div  onmouseover=\"hide_layer('".$MenuModule."_menu', event);\" style='height:5px;'></div><table width='100%'><tr>
		...
		/*	if ($_SESSION['username'] == 'matteblack') {
						//$PopMenuString.='<img src="http://www.wevolt.com/templates/modules/standard/action_star.png" hspace="3" vspace="3" border="0" width="15" class="navbuttons" id="'.$MenuModule.'_star" style="display:none;"><a href="javascript:void(0)" onclick="show_menu(\''.$MenuModule.'_star\');">SHOW</a>';
...
function build_cell($Title, $Template, $ModuleID, $FeedID, $UserID, $CellID,$SortVariable,$ContentVariable, $SearchVariable, $SearchTags, $Variable1, $Variable2, $Variable3, $Custom, $NumberVariable,$ThumbSize) {
		include_once($_SERVER['DOCUMENT_ROOT'].'/includes/db.class.php');
	global $ModuleTitleArray,$ModuleIndex,$TypeTarget, $TargetID,$MainWindowIDs,$ModHeight,$ModWidth, $IsFriend, $IsOwner, $IsFan; 
	$TabString = '';
	$NotSetup = 0;
...
<tr>
	...
	$TabString .= '<td align="left"><select name="txtModuleSelect" onChange="mod_tab(this.options[this.selectedIndex].value);" style="width:95%; height:20px; font-size:12px;">'; 
	$TabString .= '<option value=\'\' style="background-color:#396ea4;color:#fed800;" disabled="disabled">Label: ';
...
<tr>
	...
	//	$ModuleString .= get_feed_items($module, $FeedID, $UserID);
		//$ModuleString .='<div id="'.$module.'_menu_wrapper" style="display:none;"><a href="javascript:void(0)" onclick="mini_menu(\''.$module.'_menu\',\'\',\''.$CellID.'_menu\',\'wevolt\',\'\',this, event);return false;"><img src="http://www.wevolt.com/templates/modules/standard/action_star.png" hspace="3" vspace="3" border="0" width="15" class="navbuttons"></a></div>';
		$ModuleString .= '</div>';
		$ModCount++;
	}
...
<tr>
	...
	//	print 'Main Window title = ' . $MainWindowTitle.'<br/>';
		...
		$TabString .= '</select></td><td class=\'nav_links_white\'>&nbsp;&nbsp;<a href="javascript:void(0)" onclick="edit_module(\''.$CellID.'\');">edit</a></td></tr></table><div style="height:10px;"></div>';
	
	}
	

	$ModuleString .= $TabString.'<div style="height:4px;"></div></td><td id="modtopright" valign="top" align="right"><a href="javascript:void(0)"><img src="http://www.wevolt.com/templates/modules/standard/action_star.png" hspace="3" vspace="3" border="0" width="15"></a></td>
