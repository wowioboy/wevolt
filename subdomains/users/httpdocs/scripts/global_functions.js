...
function like_content (contentid, contenttype, target, contentlink) {
	attach_file('/processing/like_api.php?id='+contentid+'&type='+contenttype+'&target='+target+'&link='+escape(contentlink));
}
