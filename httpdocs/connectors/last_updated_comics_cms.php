...
$db2 = new DB();
	...
	$query = "select * from comics as c where c.installed = 1 and c.Published = 1 and c.CMSToken='$Token' ORDER BY c.PagesUpdated DESC";
	$db->query($query);
	...
	$query = "select PublishDate from pfw_blog_posts where PublishDate<='$Today' and ComicID='$ComicID' order by PublishDate DESC";
