...
#**********************************************************************************************************************************
my $TEMP_DIR        = '/var/www/vhosts/wevolt.com/httpdocs/temp/';                    # * ATTENTION * : The $TEMP_DIR value MUST be duplicated in the "ubr_ini.php" file
...
my $UBER_VERSION = "6.7.2";                                # Version of UU
my $THIS_VERSION = "3.1";                                  # Version of this script
...
if($config{'redirect_method'} > 0){
	...
	if(!$config{'embedded_upload_results'}){ $redirect_url .= '&break_frame=1'; }
