...
$PageTitle .= 'SAN DIEGO Comic Con Promotional Trial Offer';
$TrackPage = 0;
$ShowForm = true;
      ...
      <? }?>
        <div style="padding:10px;" align="center">
          <div class="spacer"></div>
               ...
               <table>
                 <tr><td <? if ($ShowForm) {?>colspan="2"<? }?>><img src="http://www.wevolt.com/images/comic_con_offer_banner.png" /></td></tr><tr><? if ($ShowForm) {?><td><img src="http://www.wevolt.com/images/offer_text.png" /></td><? }?><td>
...
<input type="hidden" name="type" id="type" value="hosted">
<input type="hidden" name="start" value="1">
<input type="hidden" name="txtSubType" id="SubType" value="<? echo $SubType;?>">
</form>
