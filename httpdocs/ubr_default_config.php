...
$_CONFIG['max_upload_size']                       = 5242880;                                                                                      // Maximum upload size (5 * 1024 * 1024 = 5242880 = 5MB)
$_CONFIG['overwrite_existing_files']              = 0;                                                                                            // Overwrite any existing files by the same name in the upload folder
$_CONFIG['redirect_url']                          = 'http://' . $_SERVER['HTTP_HOST'] . '/ubr_finished.php';                                      // What page to load after the upload completes
...
$_CONFIG['allow_extensions']                      = '(wma|wmv|mpg3|mpg|mpeg|avi|mov|jpg|jpeg|gif|bmp|png|tiff|flv|pdf|dov|xls|csv)';                                  // Include file extentions that are allowed to be uploaded
