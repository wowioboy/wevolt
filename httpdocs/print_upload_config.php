...
$_CONFIG['config_file_name']                      = 'print_upload_config';                                                                         // Name of this config file
...
$_CONFIG['redirect_url']                          = 'http://' . $_SERVER['HTTP_HOST'] . '/print_upload_finished.php';                                      // What page to load after the upload completes
...
$_CONFIG['allow_extensions']                      = '(jpg|png|jpeg|gif|tiff|psd|ai|zip|eps|tif)';                                  // Include file extentions that are allowed to be uploaded
