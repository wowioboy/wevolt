...
$dbname = 'mydb';
  ...
  class DB
  {
   ...
   function DB($base = null, $server = null, $user = null, $pass = null)
    ...
    function fetchRow($query, $debug = false)
    {
    	$query = "$query LIMIT 1";
	    $this->nbQueries++;
      	$result = mysql_query($query) or $this->debugAndDie($query);
...
class Danb 
{
	...
	{
		$this->_host = PANELDBHOST;
		$this->_user = PANELDBUSER;
		$this->_pass = PANELDBPASS;
		$this->_scheme = PANELDB;
