<?
if (($ModuleType == 'list') || ($ModuleType == 'box_list'))  {
...
<textarea rows="1"  style="width:180px; height:30px;" name="txtEmbed" id="txtEmbed" onFocus="doClear(this)" onBlur="setDefault(this)"><? echo $FeedItemArray->EmbedCode;?></textarea><div style="height:5px;"></div>
...
<input type="text" style="width:98%;" id="txtLink" name="txtLink" value="<? echo $FeedItemArray->Link;?>" ><div style="height:10px;"></div>
</div>
