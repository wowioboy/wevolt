...
function build_popup_menus($MenuModule,$CellID,$MenuModuleTemplate,$MenuModuleType) {
	...
	//	print '<br/>';
			   	...
			   	if ($Template == 'content_thumb') {
						...
						$String .= '</a>';
							...
							$String .= "<table border='0' cellspacing='0' cellpadding='0' width='".($ModuleTitleArray[$ModuleIndex]['Width']-55)."'><tr>
										...
										if ($line->Thumb != '') {
											$String .= "<a href='".$line->Link."'><img src='".$line->Thumb."' alt='LINK' width='50' align='left' hspace='3' vspace='3' style='border:2px #000000 solid;'></a>";
								$String .= "<div class='sender_name'><a href='".$line->Link."'>".$line->Title."</a></div><div class='messageinfo' ";
											...
											>".myTruncate($line->Description, 25, ' ')."</div>";
		...
		//	$String.="<div id='".$ModuleID."_menu' style='display:none; position:absolute;' class='action_pop'><div  onmouseover=\"hide_layer('".$ModuleID."_menu', event);\" style='height:5px;'></div><table width='100%'><tr>
				...
				if ($Template == 'twitter') {
					...
					//$String.="<div id='".$ModuleID."_menu' style='display:none; position:absolute;' class='action_pop'><div  onmouseover=\"hide_layer('".$ModuleID."_menu', event);\" style='height:5px;'></div><table width='100%'><tr>
							//<td onmouseover=\"hide_layer('".$ModuleID."_menu', event);\" width='5'></td><td>";
							//$String.="<a href='#' onclick=\"edit_window('".$Cell.'-'.$ModuleID."','twitter','edit','myvolt');hide_layer('".$ModuleID."_menu', event);\">edit window</a>";
							
							//$String.="</td><td onmouseover=\"hide_layer('".$ModuleID."_menu', event);\" width='5'></td></tr></table><div  onmouseover=\"hide_layer('".$ModuleID."_menu', event);\" style='height:5px;'></div></div>";
							
				} else if ($Template == 'excite_single') {
							$query = "select e.Blurb, e.ContentID, e.ContentType, e.Comment, e.Link, u.avatar, u.username, p.thumb
		 				 			 from excites as e
									...
									if ($ExciteArray->ContentType == 'user') 
										...
										$Thumb = "http://www.panelflow.com".$ExciteArray->thumb;
						...
						//	$String.="<div id='".$ModuleID."_menu' style='display:none; position:absolute;' class='action_pop'><div  onmouseover=\"hide_layer('".$ModuleID."_menu', event);\" style='height:5px;'></div><table width='100%'><tr>
							//<td onmouseover=\"hide_layer('".$ModuleID."_menu', event);\" width='5'></td><td>";
							//$String.="<a href='#' onclick=\"update_excite('');hide_layer('".$ModuleID."_menu', event);\">edit</a><br/><a href='/".trim($_SESSION['username'])."/?t=excites'>archives</a>";
...
<tr>
	...
	//$ModuleTabIDArray = array($ModuleID);
	  ...
	  $PopMenuString .= build_popup_menus($MainWindowID,$CellID,$ModuleTemplate,$ModuleType);
