...
//----------------------------------------------------------------------------------------------------
    ...
    var $absValuesFont = 'Verdana, Helvetica';   // abs. values font family: string (CSS specification)
    ...
    var $percValuesFont = 'Verdana, Helvetica';  // perc. values font family: string (CSS specification)
    ...
    var $legendFont = 'Verdana, Helvetica';      // legend font family: string (CSS specification)
