...
$_CONFIG['config_file_name']                      = 'task_fileapproval_config';                                                                         // Name of this config file
...
$_CONFIG['redirect_url']                          = 'http://' . $_SERVER['HTTP_HOST'] . '/task_approval_upload_finished.php';                                      // What page to load after the upload completes
...
$_CONFIG['allow_extensions']                      = '(wma|wmv|mpg3|mpg|mpeg|avi|mov|jpg|jpeg|gif|bmp|png|tiff|flv|pdf|doc|xls|csv|ai|psd|eps|zip|rar|swf|fla|txt|rtf)';                                  // Include file extentions that are allowed to be uploaded
