...
$_CONFIG['config_file_name']                      = 'blog_upload_config';                                                                         // Name of this config file
...
$_CONFIG['redirect_url']                          = 'http://' . $_SERVER['HTTP_HOST'] . '/blog_upload_finished.php';                                      // What page to load after the upload completes
...
$_CONFIG['allow_extensions']                      = '(jpg|png|jpeg|gif|swf|zip)';                                  // Include file extentions that are allowed to be uploaded
