...
$_SESSION['fileuploadtaskid'] = $_GET['id'];
//******************************************************************************************************
...
if($MULTI_CONFIGS_ENABLED){
	...
	//   Put your multi config file code here. eg
		 if($_SESSION['uploadtype'] == 'approval'){ 
		 			$config_file = 'task_fileapproval_config.php'; 
	 	} else {
	 		$config_file = 'task_fileapproval_config.php'; 
		}
...
<html>
	<head>
		...
		<script language="javascript" type="text/javascript">
			...
			document.uu_upload.catSelectBox.length = 0;
					...
					document.uu_upload.catSelectBox.options[10] = new Option("Pencils", "pencils", false, false);
					document.uu_upload.catSelectBox.options[11] = new Option("Colors", "colors", false, false);
					document.uu_upload.catSelectBox.options[12] = new Option("Inks", "inks", false, false);
					document.uu_upload.catSelectBox.options[13] = new Option("Letters", "letters", false, false);
					document.uu_upload.catSelectBox.options[14] = new Option("Covers", "covers", false, false);
					document.uu_upload.catSelectBox.options[15] = new Option("Finished Pages", "finished", false, false);			
			}
			setCatSelect();
		</script>
		<script language="javascript" type="text/javascript" src="<?php print $PATH_TO_JS_SCRIPT; ?>"></script>
	</head>
	<body onLoad="iniFilePage()">
    <div>
    <div class="ubrAlert2">Enter all information about your upload</div>
  ...
  <tr>
    <td width="117" valign="top" style="padding:5px;color:#000000;"> File Category<br>
                ...
                <option value="final pages">Final Pages</option>
			</select>				<br></td>
<td width="459" rowspan="2"valign="top" style="padding:5px;color:#000000;">Title (if none given, filename is used)<br>
...
<textarea name="txtDescription" style="width:100%; height:50px;"></textarea></td>
  ...
  <tr>
    <td valign="top" style="padding:5px;color:#000000;"></td>
  </tr>
</table>
                <div style="height:10px;"></div>
                <div align="center" style="font-size:18px; color:#000000;">Please Select your files to upload, you can upload up to 10 files at a time.</div>
                ...
                <input type='hidden' name='txtTask' value="<? echo $_SESSION['fileuploadtaskid'];?>">
