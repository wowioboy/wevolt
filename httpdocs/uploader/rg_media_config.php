...
$_CONFIG['config_file_name']                      = 'rg_media_config';                                                                         // Name of this config file
$_CONFIG['upload_dir']                            = '/var/www/vhosts/panelflow.com/httpdocs/temp/';                                                  // Path to upload directory
...
$_CONFIG['redirect_url']                          = 'http://' . $_SERVER['HTTP_HOST'] . '/uploader/rg_media_finished.php';                                      // What page to load after the upload completes
