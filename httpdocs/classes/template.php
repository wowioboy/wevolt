	...
	class template {
		...
		function __construct($ProjectID,$CurrentTheme,$SkinCode,$TemplateCode, $MenuCustom) {
							...
							$query =  "SELECT ts.*,tsk.*, t.HTMLCode, t.MenuLayout, p.SafeFolder
								...
								join template_settings as ts on ('$TemplateCode'=ts.TemplateCode and th.ID=ts.ThemeID and ts.ProjectID='$ProjectID')
							...
							list($TopRightCornerWidth,$TopRightCornerHeight)= @getimagesize($_SERVER['DOCUMENT_ROOT'].'/templates/skins/'.$SkinCode.'/images/'.$this->TemplateArray->ModTopRightImage);
							...
							list($TopLeftCornerWidth,$TopLeftCornerHeight)= @getimagesize($_SERVER['DOCUMENT_ROOT'].'/templates/skins/'.$SkinCode.'/images/'.$this->TemplateArray->ModTopLeftImage);
							...
							list($BottomRightCornerWidth,$BottomRightCornerHeight)= @getimagesize($_SERVER['DOCUMENT_ROOT'].'/templates/skins/'.$SkinCode.'/images/'.$this->TemplateArray->ModBottomRightImage);
							...
							list($BottomLeftCornerWidth,$BottomLeftCornerHeight)= @getimagesize($_SERVER['DOCUMENT_ROOT'].'/templates/skins/'.$SkinCode.'/images/'.$this->TemplateArray->ModBottomLeftImage);
							if ($BottomLeftCornerWidth == '')
								$BottomLeftCornerWidth = '15';
							
							
							if ($BottomLeftCornerHeight == '')
								$BottomLeftCornerHeight = '15';
								
							list($LeftSideWidth,$LeftSideHeight)= @getimagesize($_SERVER['DOCUMENT_ROOT'].'/templates/skins/'.$SkinCode.'/images/'.$this->TemplateArray->ModLeftSideImage);
							if ($LeftSideWidth == '')
								$LeftSideWidth = '15';
						
							
							list($RightSideWidth,$RightSideHeight)= @getimagesize($_SERVER['DOCUMENT_ROOT'].'/templates/skins/'.$SkinCode.'/images/'.$this->TemplateArray->ModRightSideImage);
							if ($RightSideWidth == '')
								$RightSideWidth = '15';
					
							
							list($TopImageWidth,$TopImageHeight)= @getimagesize($_SERVER['DOCUMENT_ROOT'].'/templates/skins/'.$SkinCode.'/images/'.$this->TemplateArray->ModTopImage);
							
							if ($TopImageHeight == '')
								$TopImageHeight = '15';
							
							list($BottomImageWidth,$BottomImageHeight)= @getimagesize($_SERVER['DOCUMENT_ROOT'].'/templates/skins/'.$SkinCode.'/images/'.$this->TemplateArray->ModBottomImage);
							
							if ($BottomImageHeight == '')
								$BottomImageHeight = '15';
								

							$this->ModuleBoxArray = array(
													'RightSideWidth'=>$RightSideWidth,
													'LeftSideWidth'=>$LeftSideWidth,
													'TopImageHeight'=>$TopImageHeight,
													'BottomImageHeight'=>$BottomImageHeight,
													'BottomLeftCornerHeight'=>$BottomLeftCornerHeight,
													'BottomLeftCornerWidth'=>$BottomLeftCornerWidth,
													'TopLeftCornerHeight'=>$TopLeftCornerHeight,
													'TopLeftCornerWidth'=>$TopLeftCornerWidth,
													'TopRightCornerWidth'=>$TopRightCornerWidth,
													'TopRightCornerHeight'=>$TopRightCornerHeight,
													'BottomRightCornerHeight'=>$BottomRightCornerHeight,
													'BottomRightCornerWidth'=>$BottomRightCornerWidth,
													'RightSideWidth'=>$RightSideWidth,
													'LeftSideWidth'=>$LeftSideWidth
													);
		...
		public function getTemplateSection($Section) {
					...
					switch ($Section) {
						...
						$VAlign = 'vertical-align:'.$TargetVAlign.';';
						$BackgroundImagePosition = $TargetBackgroundImagePosition;
						$Padding = 'padding:'.trim($TargetPadding).';';
						if ($TargetBackground != '')
						...
						if ($TargetImage != '')
							$Image = '<img src="/'.$TargetImage.'" border="0"><br/>';
		...
		function setTemplate() {
				...
				$this->TemplateHTML=str_replace("{ContentStyle}",$ContentContentSection['Style'],$this->TemplateHTML);
		...
		function drawStyle() {
					...
					echo '.CommentOddBGColor {
						   background-color:#'.$SkinArray->CommentOddBGColor.';';
					...
					echo '}';
					echo '.CommentEvenBGColor {
						   background-color:#'.$SkinArray->CommentEvenBGColor.';';
						    if ($SkinArray->ContentBoxTextColor != '') 
                            	echo 'color:#'.$SkinArray->ContentBoxTextColor.';';
                           else 
                           		echo 'color:#000000;';
					...
					echo '#projectmodrightside {';
                           ...
                           if ($SkinArray->ModRightSideBGColor != '')
                            ...
                            echo 'width: '.$this->ModuleBoxArray['RightSideWidth'].'px;
					}';
					...
					echo '#projectmodleftside {';
                           ...
                           if ($SkinArray->ModRightSideBGColor != '')
                            ...
                            echo 'width: '.$this->ModuleBoxArray['LeftSideWidth'].'px;
					...
					echo '#projectmodtop {';
                           ...
                           echo 'height:'.$this->ModuleBoxArray['TopImageHeight'].'px;
					}';
					...
					echo '#projectmodbottom { ';
						 if ($SkinArray->ModBottomImage != '') 
                            ...
                            echo 'height:'.$this->ModuleBoxArray['BottomImageHeight'].'px;
					...
					echo '#projectmodbottomleft {';
						 if ($SkinArray->ModBottomLeftImage != '') 
                           ...
                           echo 'height:'.$this->ModuleBoxArray['BottomLeftCornerHeight'].'px;
                            	width:'.$this->ModuleBoxArray['BottomLeftCornerWidth'].'px;
					}';
					...
					echo '#projectmodtopleft {'; 
                            ...
                            echo 'height:'.$this->ModuleBoxArray['TopLeftCornerHeight'].'px;
                            width:'.$this->ModuleBoxArray['TopLeftCornerWidth'].'px; 
					}';
					...
					echo '#projectmodtopright {';
						  if ($SkinArray->ModTopRightImage != '') 
                            ...
                            echo 'height:'.$this->ModuleBoxArray['TopRightCornerHeight'].'px;
                            width:'.$this->ModuleBoxArray['TopRightCornerWidth'].'px; 
					}';
					...
					echo '#projectmodbottomright { ';
                           ...
                           echo 'height:'.$this->ModuleBoxArray['BottomRightCornerHeight'].'px;
                            width:'.$this->ModuleBoxArray['BottomRightCornerWidth'].'px; 
					}';
					...
					echo '#bubblebottom {';
						 if ($SkinArray->ModBottomImage != '') 
                            ...
                            echo 'height:'.$BottomImageHeight.'px;
					...
					echo '#bubblebottomleft {';
                            ...
                            echo 'height:'.$BottomLeftCornerHeight.'px;
                            width:'.$BottomLeftCornerWidth.'px;
					}';
					...
					echo '#bubbletopleft{';
                            ...
                            echo 'height:'.$TopLeftCornerHeight.'px;
                            width:'.$TopLeftCornerWidth.'px;
					}';
					...
					echo '#bubbletopright{';
						 if ($SkinArray->ModTopRightImage != '')
                           ...
                           echo 'height:'.$TopRightCornerHeight.'px;
                            	 width:'.$TopRightCornerWidth.'px;
					}';
					...
					echo '#bubblebottomright{';
                            ...
                            echo 'height:'.$BottomRightCornerHeight.'px;
                            width:'.$bottomRightCornerWidth.'px;
					}';
		 ...
		 public function getModuleSizes() {
				return $this->ModuleBoxArray; 
		 }
		public function build_menus($theme,$project,$custom,$MenuLayout) {
					...
					while ($line = $db->fetchNextObject()) { 
						...
						if ($Button != '') {
							...
							$LinkStuff .= '<img src="'.$MenuImageDir.'/images/'.$Button.'" id="'.$ContentSection.'_'.Button.'" alt="'.$line->Title.'" border="0"';
							if ($ButtonRollOver != '') 
								$LinkStuff .= ' onMouseOver="this.src=\''.$MenuImageDir.'/images/'.$ButtonRollOver.'\';"onMouseOver="this.src=\''.$MenuImageDir.'/images/'.$Button.'\';"';
							$LinkStuff .= '/>'; 
						} else {
		...
		public function getBodyStyle() {
					...
					if ($SkinArray->GlobalSiteBGImage != '') {
							$this->BodyStyle .= 'background-image:url(http://www.wevolt.com/templates/skins/'.$this->SkinCode.'/images/'.$SkinArray->GlobalSiteBGImage.');';
							if ($SkinArray->GlobalSiteImageRepeat == 'none')
								$BGRepeat = 'no-repeat';
							else 
								$BGRepeat =$SkinArray->GlobalSiteImageRepeat;
							$this->BodyStyle .= 'background-repeat:'.$BGRepeat.';';
					}
					$this->BodyStyle .= 'color:#'.$SkinArray->GlobalSiteTextColor.';';
					$this->BodyStyle .= 'font-size:'.$SkinArray->GlobalSiteFontSize.'px;';
					$this->BodyStyle .= 'background-color:#'.$SkinArray->GlobalSiteBGColor.';';
