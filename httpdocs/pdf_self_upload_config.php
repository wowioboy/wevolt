...
$_CONFIG['config_file_name']                      = 'pdf_self_upload_config';                                                                         // Name of this config file
...
$_CONFIG['allow_extensions']                      = '(pdf)';                                  // Include file extentions that are allowed to be uploaded
$_CONFIG['disallow_extensions']                   = '(wma|wmv|mpg3|mpg|mpeg|avi|mov|sh|php|php3|php4|php5|py|shtml|phtml|html|htm|asp|aspx|exe|cgi|pl|plx|htaccess|htpasswd|bmp|tiff|flv|doc|xls|csv|ai|psd|eps|zip|rar|swf|fla|txt|rtf|jpeg|gif|png)';  // Include file extentions that are NOT allowed to be uploaded
