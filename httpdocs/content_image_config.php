...
$_CONFIG['config_file_name']                      = 'content_image_config';                                                                         // Name of this config file
$_CONFIG['upload_dir']                            = $_SERVER['DOCUMENT_ROOT'] . '/temp/';                                                  // Path to upload directory
...
$_CONFIG['show_files_uploaded']                   = 0;                                                                                            // Show files uploaded info
$_CONFIG['show_current_file']                     = 0;                                                                                            // Show files uploaded info
$_CONFIG['show_current_position']                 = 0;                                                                                            // Show current bytes uploaded info
$_CONFIG['show_elapsed_time']                     = 0;                                                                                            // Show elapsed time info
$_CONFIG['show_est_time_left']                    = 1;                                                                                            // Show estimated time left info
$_CONFIG['show_est_speed']                        = 0;                                                                                            // Show estimated speed info
...
$_CONFIG['max_upload_size']                       = 1131072000;                                                                                      // Maximum upload size (5 * 1024 * 1024 = 5242880 = 5MB)
$_CONFIG['overwrite_existing_files']              = 0;                                                                                            // Overwrite any existing files by the same name in the upload folder
$_CONFIG['redirect_url']                          = 'http://' . $_SERVER['HTTP_HOST'] . '/content_upload_finished.php';                                      // What page to load after the upload completes
...
$_CONFIG['allow_extensions']                      = '(jpg|png|jpeg|gif)';                                  // Include file extentions that are allowed to be uploaded
$_CONFIG['disallow_extensions']                   = '(wma|wmv|mpg3|mpg|mpeg|avi|mov|sh|php|php3|php4|php5|py|shtml|phtml|html|htm|asp|aspx|exe|cgi|pl|plx|htaccess|htpasswd|bmp|flv|doc|xls|csv|rar|swf|fla|txt|rtf)';  // Include file extentions that are NOT allowed to be uploaded
...
$_CONFIG['path_to_upload']                        = 'http://'. $_SERVER['HTTP_HOST'] . '/temp/';                                           // Used for a web link to the uploaded file
...
$_CONFIG['to_email_address']                      = 'matt@outlandentertainment.com';                                                    // To Email addresses
$_CONFIG['from_email_address']                    = 'admin@outlandip.com';                                                                         // From email address
