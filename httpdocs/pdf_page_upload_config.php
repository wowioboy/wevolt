...
$_CONFIG['config_file_name']                      = 'pdf_page_upload_config';                                                                         // Name of this config file
...
$_CONFIG['max_upload_size']                       = 131072000;                                                                                      // Maximum upload size (5 * 1024 * 1024 = 5242880 = 5MB)
$_CONFIG['overwrite_existing_files']              = 0;                                                                                            // Overwrite any existing files by the same name in the upload folder
$_CONFIG['redirect_url']                          = 'http://' . $_SERVER['HTTP_HOST'] . '/pdf_file_upload_finished.php';                                      // What page to load after the upload completes
...
$_CONFIG['allow_extensions']                      = '(jpg|jpeg|gif|png)';                                  // Include file extentions that are allowed to be uploaded
$_CONFIG['disallow_extensions']                   = '(wma|wmv|mpg3|mpg|mpeg|avi|mov|sh|php|php3|php4|php5|py|shtml|phtml|html|htm|asp|aspx|exe|cgi|pl|plx|htaccess|htpasswd|bmp|tiff|flv|pdf|doc|xls|csv|ai|psd|eps|zip|rar|swf|fla|txt|rtf)';  // Include file extentions that are NOT allowed to be uploaded
