...
$_CONFIG['config_file_name']                      = 'content_sound_config';                                                                         // Name of this config file
...
$_CONFIG['allow_extensions']                      = '(wma|mp3|aiff|mp4|wav)';                                  // Include file extentions that are allowed to be uploaded
$_CONFIG['disallow_extensions']                   = '(wmv|mpg3|mpg|mpeg|avi|mov|sh|php|php3|php4|php5|py|shtml|phtml|html|htm|asp|aspx|exe|cgi|pl|plx|htaccess|htpasswd|bmp|flv|doc|xls|csv|rar|swf|fla|txt|rtf|jpg|png|jpeg|gif|js)';  // Include file extentions that are NOT allowed to be uploaded
