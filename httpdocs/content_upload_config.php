...
$_CONFIG['config_file_name']                      = 'content_upload_config';                                                                         // Name of this config file
...
$_CONFIG['allow_extensions']                      = '(jpg|png|jpeg|gif|wma|wmv|mpg3|mpg|mpeg|avi|mov|flv|swf|bmp)';                                  // Include file extentions that are allowed to be uploaded
$_CONFIG['disallow_extensions']                   = '(sh|php|php3|php4|php5|py|shtml|phtml|html|htm|asp|aspx|exe|cgi|pl|plx|htaccess|htpasswd|bmp|doc|xls|csv|rar|fla|txt|rtf|js)';  // Include file extentions that are NOT allowed to be uploaded
