...
if ($sort == 1) {
				$sql = "select * from comics where installed = 1 and Published = 1 ORDER BY title ASC";
				
				} else if ($sort == 2) {
				$sql = "select * from comics where installed = 1 and Published = 1 ORDER BY createdate DESC";
				
				} else if ($sort == 3) {
				$sql = "select * from comics where installed = 1 and Published = 1 ORDER BY PagesUpdated DESC";
...
$pager = new PS_Pagination($conn,$sql,12,5);
	...
	//The paginate() function returns a mysql result set 
		...
		if ($fileUrl == '')
			...
			//}
			echo "</a><div class='smspacer'></div><div class='moreinfo'><a href='/".$row['SafeFolder']."/'><img src='/images/info.jpg' border='0'></a><div class='updated'>updated: <b>".$Updated."</b></div><div class='pages'>Pages: ".$row['pages']."</div></div></td>"; 
			 $counter++;
 				if ($counter == 4){
 					echo "</tr><tr>";
 					$counter = 0;
