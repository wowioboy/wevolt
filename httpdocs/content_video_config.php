...
$_CONFIG['config_file_name']                      = 'content_video_config';                                                                         // Name of this config file
...
$_CONFIG['allow_extensions']                      = '(wmv|mpg3|mpg|mpeg|avi|mov|flv)';                                  // Include file extentions that are allowed to be uploaded
$_CONFIG['disallow_extensions']                   = '(sh|php|php3|php4|php5|py|shtml|phtml|html|htm|asp|aspx|exe|cgi|pl|plx|htaccess|htpasswd|bmp|doc|xls|csv|rar|swf|fla|txt|rtf|jpg|png|jpeg|gif|wma|mp3|aiff|mpa)';  // Include file extentions that are NOT allowed to be uploaded
