...
if($MULTI_CONFIGS_ENABLED){
	...
	//   Put your multi config file code here. eg
	 if($_SESSION['uploadtype'] == 'pdf'){ 
		 		$config_file = 'pdf_page_upload_config.php'; 
	 	} else if($_SESSION['uploadtype'] == 'selfpdf'){ 
		 		$config_file = 'pdf_self_upload_config.php'; 
		} else if($_SESSION['uploadtype'] == 'selfprint'){ 
		 		$config_file = 'print_upload_config.php'; 
		} else if($_SESSION['uploadtype'] == 'podprint'){ 
		 		$config_file = 'print_upload_config.php'; 
		} else if($_SESSION['uploadtype'] == 'selfmerch'){ 
		 		$config_file = 'merch_upload_config.php'; 
		}else if($_SESSION['uploadtype'] == 'podmerch'){ 
		 		$config_file = 'merch_upload_config.php'; 
		}else if($_SESSION['uploadtype'] == 'selfbook'){ 
		 		$config_file = 'book_upload_config.php'; 
		}else if($_SESSION['uploadtype'] == 'media'){ 
		 		$config_file = 'blog_upload_config.php'; 
		}else if($_SESSION['uploadtype'] == 'gallery_content'){ 
		 		$config_file = 'content_upload_config.php'; 
		}else if($_SESSION['uploadtype'] == 'gallery_image'){ 
		 		$config_file = 'content_image_config.php'; 
		}else if($_SESSION['uploadtype'] == 'gallery_video'){ 
		 		$config_file = 'content_video_config.php'; 
		}else if($_SESSION['uploadtype'] == 'gallery_sound'){ 
		 		$config_file = 'content_sound_config.php'; 
		}else if($_SESSION['uploadtype'] == 'page'){ 
		 		$config_file = 'content_image_config.php'; 
		}else if($_SESSION['uploadtype'] == 'download'){ 
		 		$config_file = 'content_image_config.php'; 
		}else {
