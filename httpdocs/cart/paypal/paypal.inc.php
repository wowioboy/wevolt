...
$paypal['image_url']     = "";
$paypal['success_url']   = "checkout_success";
...
<input type="hidden" name="hidShippingFirstName" value="<?php echo $paypal['firstname']?>"> 
<input type="hidden" name="hidShippingLastName" value="<?php echo $paypal['lastname']?>">
<input type="hidden" name="hidShippingEmail" value="<?php echo $paypal['email']?>">
<input type="hidden" name="optPayment" value="paypal"> 
