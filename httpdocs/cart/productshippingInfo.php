...
if (isset($_SESSION['id']))
{
	...
	{
		$ClientDB = new DB();
		$query = "SELECT * from users where EncryptID='" . $_SESSION['userid'] . "'";
...
<form action="/store/paypal/?t=product&type=<? echo $Type;?>&id=<? echo $ProductID;?>" method="post" name="frmCheckout" id="frmCheckout" onSubmit="return checkShippingAndPaymentInfo();">
