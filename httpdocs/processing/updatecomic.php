...
$Referal = $BaseRef[0];
	...
	$query = "INSERT into viewsbreakdown (analyticid, comicid, date, page, remote, userid, CountryName, RegionName, CityName, Latitude, Longitude,Referal, AnalyticDate) values ('$AnalyticID','$ComicID','$today','$Page','$Remote','$ID','$CountryName', '$RegionName', '$CityName', '$Latitude', '$Longitude','$Referal', '$AnalyticDate')";
		$result = mysql_query($query);
