...
<a href="/cms/admin/"><img src="/images/cms_button.png" border="0" vspace="5"/></a><? //}
...
if ($AllOrders > 0) {
echo '[<a href="/store/orders/?a=archive">VIEW ALL ORDERS</a>]<div class="spacer"></div>';
}
...
<?php if ($FriendCount == 0) echo '<div class="favs">No Friends Added Yet</div>'; else echo $friendString; ?></td>
	...
	<div class="status">What are you working on? <a href="#" onclick="showstatus();return false;">[edit]</a><div class="spacer"></div>
<div id='currentstatus'><? echo $Status;?></div></div>
   
	<? } 
	
	if (($IsCreator == 1) && ($Status != '')) {?>
        Currently working on: <? if ($_SESSION['userid'] == $ID){ ?><a href="#" onclick="showstatus();">[edit]</a><? }?>
...
ORDER BY c.title DESC";
  ...
  $comicString = "<table width='100%' cellspacing='0' cellpadding='0' border='0'><tr>";
   for ($i=0; $i< $numberComics; $i++){
	...
	$comicString .="</a><div class='smspacer'></div><div class='moreinfo'><a href='/".$row['SafeFolder']."/'><img src='/images/info.jpg' border='0'></a>";
	
	if ($ID == $_SESSION['userid']) { 
	
	$comicString .= "<div class='smspacer'></div><a href='/".$row['SafeFolder']."/stats/'><img src='/images/stats.jpg' border='0'></a>";
	}
...
You have not created any comics yet.<div class="spacer"></div><a href="/cms/create/" ><img src="/images/create_new.png" border="0"/></a>
...
<a href='".$comicURL."' target='blank'><img src='".$fileUrl."' height='120' width='100' border='2' alt='LINK' style='border-color:#000000;'></a><div class='smspacer'></div><div style='padding-left:6px;'><a href='/".$ComicsArray['SafeFolder']."/'><img src='/images/info.jpg' border='0'></a><br />
<a href='".$comicURL."' target='blank'><img src='/images/read_small.jpg' border='0'></a><br />
