...
$PageTitle = 'wevolt | weSEARCH engine';
$TrackPage = 1;
...
<table cellpadding="0" cellspacing="0" border="0" <? if ($_SESSION['IsPro'] == 1) {?> width="100%"<? }?>>
  <tr>
    ...
    <td  valign="top"  <? if ($_SESSION['IsPro'] == 1) {?>align="center"<? }?>>
       ...
       <iframe src="/get_search.php?a=search<? echo $QueryString;?>" width="800" height="850" frameborder="0" scrolling="no" allowTransparency="true"></iframe>
