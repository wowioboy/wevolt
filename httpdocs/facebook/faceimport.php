...
include_once$_SERVER['DOCUMENT_ROOT'].'/facebook-platform/php/facebook.php';
...
parent.window.location='http://users.wevolt.com/myvolt/<? echo trim($_SESSION['username']);?>/?t=profile';
</script>
<? }?>
