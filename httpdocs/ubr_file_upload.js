...
function hideUploadfields(){ document.getElementById('filesettings').style.display = "none"; }
...
function iniFilePage(){
	...
	//var iframeheight = parent.document.getElementById("loaderframe").scrollHeight;
		//	iframeheight = iframeheight + 25;
			//parent.document.getElementById("loaderframe").style.height = iframeheight+'px';
}
...
function addUploadSlot(num){
	if(upload_range < max_upload_slots){
		if(num == upload_range){
			...
			//var currentheight = parent.document.getElementById('loaderframe').height;
			//currentheight = currentheight + 5;
			//parent.document.getElementById('loaderframe').height = currentheight;
