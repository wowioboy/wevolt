...
$blogcatdb = new DB();
$query = "SELECT * from pf_blog_categories order by Title";
...
while ($line = $blogcatdb->fetchNextObject()) { 
		...
		$blogcatString .= "<div class='cat_item_mod'><a href='index.php?a=blog&c=".$line->ID."' border='1' >".$line->Title."</a><span class='menubullet'>>></span>";
}
