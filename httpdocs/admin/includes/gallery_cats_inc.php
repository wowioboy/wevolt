...
$db->query($query);
$menuString = "<table width='100%' cellpadding='0' cellspacing='0' border='0'><tr><td width='3%' class='tableheader'></td><td class='tableheader'>CATEGORY TITLE</td><td class='tableheader'>DEFAULT</td></tr><tr><td colspan='3'>&nbsp;</td></tr>";
...
$menuString .= "</table>";
?>
<form method='post' action='admin.php?a=gallery&sub=cat'>
