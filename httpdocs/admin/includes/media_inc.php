...
<div id="container">
	<div id="header">
	<form name="search" id="search" action="admin.php?a=media" method="post"><input type="text" name="sstring" id="sstring" value="<?php echo $_POST['sstring']; ?>" /><input type="button" name="search" value="search" id="searchButton" onClick="validateSearch();" /></form>
		<h3><a href="#" title="edit prefs" class="expander preferences">(edit preferences)</a></h3>
	</div>
</div>

<form name="prefs" action="admin.php?a=media" method="post" id="preferences">
Preferences:<br /><br />
<fieldset>
