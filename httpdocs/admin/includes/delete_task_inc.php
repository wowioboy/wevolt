...
<input type='submit' name='btnsubmit' value='NO' id='submitstyle' style="text-align:left;">
    ...
    <td class='adminContent' valign="top"><div class='warning'>Are you Sure you want to delete this task? <div class='spacer'></div>
      </div>
    <div class='spacer' ></div>
<div class='listcellmed'><b>TITLE:</b>&nbsp;<? echo $Title ?></div><div class='listcellmed'><b>PROJECT:</b>&nbsp;<? echo $ProjectTitle; ?></td>
