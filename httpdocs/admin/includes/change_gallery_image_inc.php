<? 
$ItemDB = new DB();
$query = "SELECT Title, GalleryID from pf_gallery_content where ID='$ItemID'";
$ItemArray = $ItemDB->queryUniqueObject($query);
$ItemTitle = $ItemArray->Title;
$GalleryID = $ItemArray->GalleryID;
...
<script type="text/javascript"> 
    ...
    var so = new SWFObject('flash/upload_images.swf','upload','700','350','9');
		...
		so.addVariable('itemtitle','<? echo $ItemTitle; ?>');
		 so.addVariable('edit','1');
