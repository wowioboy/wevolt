<? 
 $db = new DB();
$query = "select * from pf_store_categories where id='$CatID'";
$db->query($query);
...
<input type='submit' name='btnsubmit' value='NO' id='submitstyle' style="text-align:left;">
    ...
    <td class='adminContent' valign="top"><div class='warning'>Are you sure you want to delete this Category?</div><br /><div class='spacer'></div>
