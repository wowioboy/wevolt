...
<td class="profiletabactive" align="left"  id='comicstab' onMouseOver="rolloveractive('comicstab','comicslist')" onMouseOut="rolloverinactive('comicstab','comicslist')" onclick="comicstab();">COMICS</td>
<td width="5"></td>
<td class="profiletabinactive" align="left" id='infotab' onMouseOver="rolloveractive('infotab','userinfo')" onMouseOut="rolloverinactive('infotab','userinfo')" onclick="infotab();">PROFILE INFO</td>
<? if ($ID == $_SESSION['userid']) { ?>
<td width="5"></td>
<td class="profiletabinactive" align="left" id='favstab' onMouseOver="rolloveractive('favstab','favslist')" onMouseOut="rolloverinactive('favstab','favslist')" onclick="favstab();">FAVORITES</td>
<? }?>
</tr>
</table>
</div>
